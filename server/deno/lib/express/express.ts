import * as require$$0$3 from 'https://deno.land/std@0.166.0/node/path.ts';
import * as require$$0$4 from 'https://deno.land/std@0.166.0/node/tty.ts';
import * as require$$1$1 from 'https://deno.land/std@0.166.0/node/util.ts';
import * as require$$1$2 from 'https://deno.land/std@0.166.0/node/fs.ts';
import * as require$$4$1 from 'https://deno.land/std@0.166.0/node/net.ts';
import require$$0$5 from 'https://deno.land/std@0.166.0/node/events.ts';
import require$$1$3 from "https://deno.land/std@0.166.0/node/stream.ts";
import * as require$$3$1 from 'https://deno.land/std@0.166.0/node/zlib.ts';
import require$$0$6 from 'https://deno.land/std@0.166.0/node/buffer.ts';
import require$$1$4 from 'https://deno.land/std@0.166.0/node/string_decoder.ts';
import * as require$$8 from 'https://deno.land/std@0.166.0/node/querystring.ts';
import * as require$$0$7 from 'https://deno.land/std@0.166.0/node/url.ts';
import * as require$$0$8 from 'https://deno.land/std@0.166.0/node/http.ts';
import * as require$$0$9 from 'https://deno.land/std@0.166.0/node/crypto.ts';
	...
	function readStream (stream, encoding, length, limit, callback) {
	  ...
	  function onEnd (err) {
	    ...
	    if (length !== null && received !== length) {
	      ...
	      var string = decoder
	        ? buffer + (decoder.end() || '')
	        : require$$0$6.Buffer.concat(buffer);
	      done(null, string);
	    }
	  }
...
function requireJson () {
	...
	var createError = httpErrors.exports;
	var debug = src$1.exports('body-parser:json');
...
function requireRaw () {
	...
	var bytes = requireBytes();
	var debug = src$1.exports('body-parser:raw');
	var read = requireRead();
	var typeis = typeIs.exports;
...
function requireText () {
	...
	var bytes = requireBytes();
	var contentType$1 = contentType;
	var debug = src$1.exports('body-parser:text');
	var read = requireRead();
	var typeis = typeIs.exports;
...
function requireUrlencoded () {
	...
	var contentType$1 = contentType;
	var createError = httpErrors.exports;
	var debug = src$1.exports('body-parser:urlencoded');
...
var debug$5 = src$1.exports('finalhandler');
...
function send$3 (req, res, status, headers, message) {
  function write () {
    ...
    res.setHeader('Content-Length', require$$0$6.Buffer.byteLength(body, 'utf8'));
...
var debug$4 = src$1.exports('express:router:layer');
...
var debug$3 = src$1.exports('express:router:route');
...
var debug$2 = src$1.exports('express:router');
...
var debug$1 = src$1.exports('express:view');
...
function entitytag (entity) {
  ...
  var len = typeof entity === 'string'
    ? require$$0$6.Buffer.byteLength(entity, 'utf8')
    : entity.length;
...
function etag$1 (entity, options) {
  ...
  // validate argument
  if (!isStats && typeof entity !== 'string' && !require$$0$6.Buffer.isBuffer(entity)) {
...
SendStream.prototype.error = function error (status, err) {
  ...
  res.statusCode = status;
  res.setHeader('Content-Type', 'text/html; charset=UTF-8');
  res.setHeader('Content-Length', require$$0$6.Buffer.byteLength(doc));
  res.setHeader('Content-Security-Policy', "default-src 'none'");
  res.setHeader('X-Content-Type-Options', 'nosniff');
  res.end(doc);
};
...
var parse$2 = parseurl$1.exports;
var proxyaddr = proxyAddr.exports;
...
export default getDefaultExportFromCjs(express$2.exports);
