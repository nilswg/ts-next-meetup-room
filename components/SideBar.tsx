...
export const Button = () => {
  ...
  return (
    <div className="text-center">
      <button
        className="m-1 inline-flex items-center rounded-full border border-neutral-700 p-1 text-center text-sm font-medium text-neutral-700 hover:bg-neutral-700 hover:text-white focus:outline-none focus:ring-4 focus:ring-neutral-300 dark:border-neutral-500 dark:text-neutral-500 dark:hover:text-white dark:focus:ring-neutral-800"
        type="button"
